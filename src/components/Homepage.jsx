...
const Homepage = ({ time }) => {
  ...
  return (
    <div className="sm:font-uibold relative m-auto flex w-full flex-col items-center p-2 text-[40px] font-bold sm:text-[70px] xl:text-[120px]">
      <div className="relative">
        <div className="relative z-[-9] flex overflow-hidden">
          <SplitText text="HEY THERE" parclass={"word"} />
        </div>
        <div className="relative z-[-9] flex overflow-hidden">
          <SplitText text="I'M FAHRIZAL" parclass={"word"} />
        </div>
        <div className="relative z-[-9] overflow-hidden text-center font-uilight text-[12px] tracking-widest text-gray-500 sm:text-[14px] lg:text-[18px] xl:text-[21px]">
          <div className="text">Frontend developer & web designer</div>
        </div>
        <div className="relative z-[-9] hidden overflow-hidden text-center font-uilight text-[12px] tracking-widest text-gray-500 sm:block sm:text-[14px] lg:text-[18px] xl:text-[21px]">
        ...
        <div className="absolute bottom-[-100%] flex w-full items-center justify-between sm:bottom-[-45px] sm:right-[-130px] sm:block sm:w-max lg:bottom-[10px] lg:right-[-180px]">
          ...
          <div className="relative z-[-99] block items-end">
      ...
      <div className="photocover absolute left-0 right-0 top-[-50%] z-[-999] m-auto h-[300px] w-[300px] rounded-full bg-cover bg-center bg-no-repeat sm:top-[-18%] lg:top-[-15%] lg:h-[400px] lg:w-[400px] xl:top-[-5%] xl:h-[550px] xl:w-[550px]" />
    </div>
  );
};
