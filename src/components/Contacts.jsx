...
const Contacts = () => {
  ...
  return (
    <div className="flex h-full w-full flex-col items-center px-4 py-2 md:flex-row md:px-[52px] md:py-[20px]">
      <div className="flex flex-col md:w-2/3 md:pe-[48px]">
        <div className="">
          <div className="gap-2 font-neue text-3xl font-semibold md:leading-3">
            <div className="sm:text-4xl lg:text-[36px]">
              Let's connect with me ?
            </div>
            <div className="sm:mt-[18px] lg:text-[36px]">Contact me</div>
          </div>
          <div className="my-[8px] font-neue text-gray-400 md:my-[23px] lg:text-[18px]">
      ...
      <div className="mt-[20px] space-y-6 font-neue text-[18px] sm:mt-1 sm:space-y-0 md:w-1/3 md:space-y-12">
        <div className="space-y-1">
          ...
          <div className="text-[14px] md:text-[18px]">+62 8952 6195 247</div>
        </div>
